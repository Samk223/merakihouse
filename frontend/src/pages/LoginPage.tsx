        ...
        <div className="w-full md:w-1/2 bg-[#EFE5E1] pt-10 pb-4 px-8 md:pt-12 md:pb-6 md:px-10 flex flex-col justify-between items-center relative z-20">
          ...
          <div className="w-full flex-1 flex justify-center items-end mt-4">
            <img 
              ...
              onError={(e) => {
                // If user hasn't dropped the image yet, display an elegant CSS placeholder
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link
                  to="/forgot-password"
                  className="text-xs text-[#9D6C76] hover:text-[#865A63] font-body transition-all duration-300"
                >
                  Forgot Password?
                </Link>
              </div>
