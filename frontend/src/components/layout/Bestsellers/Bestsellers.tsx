    ...
    <section className="w-full flex flex-col">
      ...
      >
        ...
        <h2 className="font-body font-light text-[#2C293E] text-2xl md:text-4xl tracking-[0.25em] uppercase z-10 relative cursor-heart group/title px-6 py-2">
          ...
          <svg viewBox="0 0 24 24" fill="currentColor" className="absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#FAF6F0] opacity-0 pointer-events-none group-hover/title:animate-[popLove1_0.6s_cubic-bezier(0.3,0,0,1)_forwards]">
          ...
          <svg viewBox="0 0 24 24" fill="currentColor" className="absolute top-1/2 left-1/2 w-3 h-3 text-[#9D6C76] opacity-0 pointer-events-none group-hover/title:animate-[popLove2_0.6s_cubic-bezier(0.3,0,0,1)_forwards]">
            <path d="M12 21C12 21 3.5 14 3.5 8.5C3.5 5.5 6 3 9 3C10.8 3 11.5 4.2 12 5C12.5 4.2 13.2 3 15 3C18 3 20.5 5.5 20.5 8.5C20.5 14 12 21 12 21Z" />
          </svg>
          <svg viewBox="0 0 24 24" fill="currentColor" className="absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#E379B7] opacity-0 pointer-events-none group-hover/title:animate-[popLove3_0.6s_cubic-bezier(0.3,0,0,1)_forwards]">
            <path d="M12 21C12 21 3.5 14 3.5 8.5C3.5 5.5 6 3 9 3C10.8 3 11.5 4.2 12 5C12.5 4.2 13.2 3 15 3C18 3 20.5 5.5 20.5 8.5C20.5 14 12 21 12 21Z" />
          </svg>
          <svg viewBox="0 0 24 24" fill="currentColor" className="absolute top-1/2 left-1/2 w-3 h-3 text-[#FAF6F0] opacity-0 pointer-events-none group-hover/title:animate-[popLove4_0.6s_cubic-bezier(0.3,0,0,1)_forwards]">
            <path d="M12 21C12 21 3.5 14 3.5 8.5C3.5 5.5 6 3 9 3C10.8 3 11.5 4.2 12 5C12.5 4.2 13.2 3 15 3C18 3 20.5 5.5 20.5 8.5C20.5 14 12 21 12 21Z" />
          </svg>
          <svg viewBox="0 0 24 24" fill="currentColor" className="absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#9D6C76] opacity-0 pointer-events-none group-hover/title:animate-[popLove5_0.6s_cubic-bezier(0.3,0,0,1)_forwards]">
            <path d="M12 21C12 21 3.5 14 3.5 8.5C3.5 5.5 6 3 9 3C10.8 3 11.5 4.2 12 5C12.5 4.2 13.2 3 15 3C18 3 20.5 5.5 20.5 8.5C20.5 14 12 21 12 21Z" />
          </svg>
          <svg viewBox="0 0 24 24" fill="currentColor" className="absolute top-1/2 left-1/2 w-3 h-3 text-[#E379B7] opacity-0 pointer-events-none group-hover/title:animate-[popLove6_0.6s_cubic-bezier(0.3,0,0,1)_forwards]">
            <path d="M12 21C12 21 3.5 14 3.5 8.5C3.5 5.5 6 3 9 3C10.8 3 11.5 4.2 12 5C12.5 4.2 13.2 3 15 3C18 3 20.5 5.5 20.5 8.5C20.5 14 12 21 12 21Z" />
          </svg>
        </h2>
      </div>
      ...
      <div className="w-full py-16 md:py-24 bg-[#FAF6F0] flex items-center justify-center">
        <div className="max-w-7xl w-full mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 px-6 md:px-12">
          {bestsellerProducts.map((product) => (
            <div key={product.id} className="group flex flex-col items-start w-full relative">
              ...
              <div className="w-full aspect-square relative z-10">
                ...
                <div className="w-full h-full relative rounded-md shadow-sm border border-neutral-200/10 transition-all duration-500 ease-[cubic-bezier(0.3,0,0,1)] origin-bottom group-hover:scale-[1.35] group-hover:shadow-[0_25px_50px_rgba(40,39,63,0.20)] group-hover:z-30 z-10 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-[#FAF6F0]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-2.5 pb-3">
                    <div className="flex items-center gap-1.5 w-full transform translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 delay-[50ms] z-10">
