    ...
    <section className="w-full flex flex-col bg-[#FAF6F0]">
      ...
      >
        ...
        >
          ...
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className={`absolute top-1/2 left-1/2 w-4 h-4 text-[#E6A15C] opacity-0 pointer-events-none group-hover/title:animate-[sunBurst1_0.6s_cubic-bezier(0.3,0,0,1)_forwards] ${isTitleActive ? "animate-[sunBurst1_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""}`}>
            <circle cx="12" cy="12" r="5" fill="currentColor" />
            <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" />
          </svg>
          {/* 2. Bright Golden Star (Top-Right) */}
          <svg viewBox="0 0 24 24" fill="currentColor" className={`absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#F5C767] opacity-0 pointer-events-none group-hover/title:animate-[sunBurst2_0.6s_cubic-bezier(0.3,0,0,1)_forwards] ${isTitleActive ? "animate-[sunBurst2_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""}`}>
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          </svg>
          {/* 3. Soft Rose Sun (Middle-Left) */}
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className={`absolute top-1/2 left-1/2 w-4 h-4 text-[#A9787C] opacity-0 pointer-events-none group-hover/title:animate-[sunBurst3_0.6s_cubic-bezier(0.3,0,0,1)_forwards] ${isTitleActive ? "animate-[sunBurst3_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""}`}>
            <circle cx="12" cy="12" r="5" fill="currentColor" />
            <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" />
          </svg>
          {/* 4. White Glow Sparkle (Middle-Right) */}
          <svg viewBox="0 0 24 24" fill="currentColor" className={`absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#FAF6F0] opacity-0 pointer-events-none group-hover/title:animate-[sunBurst4_0.6s_cubic-bezier(0.3,0,0,1)_forwards] ${isTitleActive ? "animate-[sunBurst4_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""}`}>
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          </svg>
          {/* 5. Golden Sun (Bottom-Left) */}
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className={`absolute top-1/2 left-1/2 w-4 h-4 text-[#F5C767] opacity-0 pointer-events-none group-hover/title:animate-[sunBurst5_0.6s_cubic-bezier(0.3,0,0,1)_forwards] ${isTitleActive ? "animate-[sunBurst5_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""}`}>
            <circle cx="12" cy="12" r="5" fill="currentColor" />
            <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" />
          </svg>
          {/* 6. Soft Clay Sparkle (Bottom-Right) */}
          <svg viewBox="0 0 24 24" fill="currentColor" className={`absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#A9787C] opacity-0 pointer-events-none group-hover/title:animate-[sunBurst6_0.6s_cubic-bezier(0.3,0,0,1)_forwards] ${isTitleActive ? "animate-[sunBurst6_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""}`}>
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          </svg>
        </h2>
      </div>
              ...
              >
                ...
                <div className="w-full aspect-square relative">
                  ...
                  <div className={`w-full h-full bg-[#F5EFE6] rounded-md overflow-hidden border border-neutral-200/10 shadow-sm transition-transform duration-500 group-hover:scale-103 ${
                    product.id === activeCardId ? "scale-103" : ""
                  }`}>
                    <img
                  ...
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className={`absolute top-1/2 left-1/2 w-4 h-4 text-[#E6A15C] opacity-0 pointer-events-none group-hover:animate-[sunBurst1_0.6s_cubic-bezier(0.3,0,0,1)_forwards] z-20 ${
                    product.id === activeCardId ? "animate-[sunBurst1_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""
                  }`}>
                    <circle cx="12" cy="12" r="5" fill="currentColor" />
                    <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" />
                  </svg>
                  ...
                  <svg viewBox="0 0 24 24" fill="currentColor" className={`absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#F5C767] opacity-0 pointer-events-none group-hover:animate-[sunBurst2_0.6s_cubic-bezier(0.3,0,0,1)_forwards] z-20 ${
                    product.id === activeCardId ? "animate-[sunBurst2_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""
                  }`}>
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                  </svg>
                  {/* 3. Soft Rose Sun */}
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className={`absolute top-1/2 left-1/2 w-4 h-4 text-[#A9787C] opacity-0 pointer-events-none group-hover:animate-[sunBurst3_0.6s_cubic-bezier(0.3,0,0,1)_forwards] z-20 ${
                    product.id === activeCardId ? "animate-[sunBurst3_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""
                  }`}>
                    <circle cx="12" cy="12" r="5" fill="currentColor" />
                    <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" />
                  </svg>
                  ...
                  <svg viewBox="0 0 24 24" fill="currentColor" className={`absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#FAF6F0] opacity-0 pointer-events-none group-hover:animate-[sunBurst4_0.6s_cubic-bezier(0.3,0,0,1)_forwards] z-20 ${
                    product.id === activeCardId ? "animate-[sunBurst4_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""
                  }`}>
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                  </svg>
                  {/* 5. Golden Sun */}
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className={`absolute top-1/2 left-1/2 w-4 h-4 text-[#F5C767] opacity-0 pointer-events-none group-hover:animate-[sunBurst5_0.6s_cubic-bezier(0.3,0,0,1)_forwards] z-20 ${
                    product.id === activeCardId ? "animate-[sunBurst5_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""
                  }`}>
                    <circle cx="12" cy="12" r="5" fill="currentColor" />
                    <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" />
                  </svg>
                  ...
                  <svg viewBox="0 0 24 24" fill="currentColor" className={`absolute top-1/2 left-1/2 w-3.5 h-3.5 text-[#A9787C] opacity-0 pointer-events-none group-hover:animate-[sunBurst6_0.6s_cubic-bezier(0.3,0,0,1)_forwards] z-20 ${
                    product.id === activeCardId ? "animate-[sunBurst6_0.6s_cubic-bezier(0.3,0,0,1)_forwards]" : ""
                  }`}>
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                  </svg>
                </div>
